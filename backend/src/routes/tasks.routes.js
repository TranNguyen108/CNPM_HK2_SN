...
router.get('/stats/group/:groupId/commits/heatmap', ctrl.getCommitHeatmap);
router.get('/stats/group/:groupId/commits/recent', ctrl.getRecentCommits);
router.get('/stats/group/:groupId/commits/members', ctrl.getCommitsByMember);
